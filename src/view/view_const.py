...
RIGHT_ARROW = pygame.transform.scale(pygame.image.load('./src/assets/img/arrow_right.png'), (ARROW_WIDTH, ARROW_WIDTH))
LEFT_ARROW = pygame.transform.scale(pygame.image.load('./src/assets/img/arrow_left.png'), (ARROW_WIDTH, ARROW_WIDTH))
